...
export async function resetDb() {
  await prisma.$executeRawUnsafe(
    `TRUNCATE TABLE "IngestionRecord", "IngestionRun", "Patent", "Exclusivity", "GenericChallengeDrug", "GenericChallenge", "BiologicProduct", "Drug", "Company", "DataSource" RESTART IDENTITY CASCADE`,
  );
